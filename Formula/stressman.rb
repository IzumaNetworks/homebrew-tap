class Stressman < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/IzumaNetworks/stressman/releases/download/v0.1.0/stressman-darwin-arm64.tar.gz"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
    end
    on_intel do
      url "https://github.com/IzumaNetworks/stressman/releases/download/v0.1.0/stressman-darwin-amd64.tar.gz"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
    end
  end
  ...
  on_linux do
    on_arm do
      url "https://github.com/IzumaNetworks/stressman/releases/download/v0.1.0/stressman-linux-arm64.tar.gz"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
    end
    on_intel do
      url "https://github.com/IzumaNetworks/stressman/releases/download/v0.1.0/stressman-linux-amd64.tar.gz"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
    end
  end
